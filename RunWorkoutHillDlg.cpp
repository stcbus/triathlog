...
IMPLEMENT_DYNAMIC(CRunWorkoutHillDlg, CDialog)


BEGIN_MESSAGE_MAP(CRunWorkoutHillDlg, CDialog)
...
CRunWorkoutHillDlg::CRunWorkoutHillDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent /* = NULL*/) 
                : CDialog(CRunWorkoutHillDlg::IDD, pParent), 
...
CRunWorkoutHillDlg::~CRunWorkoutHillDlg()
{
}


BOOL CRunWorkoutHillDlg::OnInitDialog(void)
{
...
void CRunWorkoutHillDlg::OnAddData(void)
{
...
void CRunWorkoutHillDlg::OnConvert(void)
{
    CConverterDlg dlg;
    dlg.DoModal();
}
...
void CRunWorkoutHillDlg::OnOK(void)
{
    bool fOK;
...
void CRunWorkoutHillDlg::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CRunWorkoutHillDlg::OnUpdatePaces(void)
{
...
double CRunWorkoutHillDlg::GetSeconds(void) const
{
    return m_dSeconds;
}


int CRunWorkoutHillDlg::GetTemperature(void) const
{
    return m_nTemp;
}


int CRunWorkoutHillDlg::GetHR(void) const
{
    return m_nHR;
}


bool CRunWorkoutHillDlg::IsLong(void) const
{
    return m_fLong;
}


CString CRunWorkoutHillDlg::GetNotes(void) const
{
    return m_strNotes;
}


CString CRunWorkoutHillDlg::GetDispName(void) const
{
    return m_strDisp;
}


double CRunWorkoutHillDlg::GetMiles(void) const
{
    return m_dMiles;
}


CLocationRun* CRunWorkoutHillDlg::GetLocation(void) const
{
    return m_pLocation;
}


CShoesRun* CRunWorkoutHillDlg::GetShoes(void) const
{
    return m_pShoes;
}


int CRunWorkoutHillDlg::GetWind(void) const
{
    return m_nWind;
}


double CRunWorkoutHillDlg::GetSpecialSeconds(void) const
{
    return m_dHillSeconds;
}


double CRunWorkoutHillDlg::GetSpecialMiles(void) const
{
    return m_dHillMiles;
}


void CRunWorkoutHillDlg::SetSeconds(double dSec)
{
    m_dSeconds = dSec;
}


void CRunWorkoutHillDlg::SetTemperature(int nTemp)
{
    m_nTemp = nTemp;
}


void CRunWorkoutHillDlg::SetHR(int nHR)
{
    m_nHR = nHR;
}


void CRunWorkoutHillDlg::SetLong(bool fLong)
{
    m_fLong = fLong;
}


void CRunWorkoutHillDlg::SetNotes(CString str)
{
    m_strNotes = str;
}


void CRunWorkoutHillDlg::SetDispName(CString str)
{
    m_strDisp = str;
}


void CRunWorkoutHillDlg::SetMiles(double dMiles)
{
    m_dMiles = dMiles;
}


void CRunWorkoutHillDlg::SetLocation(CLocationRun* pLocation)
{
    m_pLocation = pLocation;
}


void CRunWorkoutHillDlg::SetShoes(CShoesRun* pShoes)
{
    m_pShoes = pShoes;
}


void CRunWorkoutHillDlg::SetWind(int nWind)
{
    m_nWind = nWind;
}


void CRunWorkoutHillDlg::SetSpecialSeconds(double dSec)
{
    m_dHillSeconds = dSec;
}


void CRunWorkoutHillDlg::SetSpecialMiles(double dMiles)
{
    m_dHillMiles = dMiles;
}