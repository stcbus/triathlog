...
BEGIN_MESSAGE_MAP(CSheetSwimDrillsPage, CSheetTriathLogPage)
...
CSheetSwimDrillsPage::CSheetSwimDrillsPage(void) : CSheetTriathLogPage(CSheetSwimDrillsPage::IDD)
{
}


BOOL CSheetSwimDrillsPage::OnInitDialog(void)
{
...
bool CSheetSwimDrillsPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetSwimDrillsPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetSwimDrillsPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetSwimDrillsPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetSwimDrillsPage::OnUpdatePaces(void)
{
