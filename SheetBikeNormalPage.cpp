...
BEGIN_MESSAGE_MAP(CSheetBikeNormalPage, CSheetTriathLogPage)
...
CSheetBikeNormalPage::CSheetBikeNormalPage(void) : CSheetTriathLogPage(CSheetBikeNormalPage::IDD)
{
}


BOOL CSheetBikeNormalPage::OnInitDialog(void)
{
...
bool CSheetBikeNormalPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetBikeNormalPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetBikeNormalPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetBikeNormalPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetBikeNormalPage::OnUpdatePaces(void)
{
