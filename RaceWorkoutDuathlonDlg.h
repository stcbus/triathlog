...
class CRaceWorkoutDuathlonDlg : public CDialog
{
public:
	CRaceWorkoutDuathlonDlg(COURSEDUATHLONARRAY& rarCourse, SHOESRUNARRAY& rarShoesRun, 
                            SHOESBIKEARRAY& rarShoesBike, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CRaceWorkoutDuathlonDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRACEDUATHLON };

    CCourseDuathlon* GetCourseDuathlon(void) const;
    ...
    CShoesRun* GetLeg1Shoes(void) const;
    ...
    CShoesRun* GetLeg1RaceShoes(void) const;
    CShoesBike* GetLeg2RaceShoes(void) const;
    CShoesRun* GetLeg3RaceShoes(void) const;

    void SetCourseDuathlon(CCourseDuathlon* pCourse);
    ...
    void SetLeg1RaceShoes(CShoesRun* pShoes);
...
protected:
    ...
    DECLARE_DYNAMIC(CRaceWorkoutDuathlonDlg)
    DECLARE_MESSAGE_MAP()
...
protected:
    ...
    int m_nLeg2HR;
    int m_nLeg3HR;
    CShoesRun* m_pLeg1Shoes;
    CShoesBike* m_pLeg2Shoes;
    CShoesRun* m_pLeg3Shoes;
    CShoesRun* m_pLeg1RaceShoes;
    ...
    COURSEDUATHLONARRAY& m_rarCourses;
