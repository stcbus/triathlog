...
IMPLEMENT_DYNAMIC(CRunWorkoutPoolDlg, CDialog)


BEGIN_MESSAGE_MAP(CRunWorkoutPoolDlg, CDialog)
...
CRunWorkoutPoolDlg::CRunWorkoutPoolDlg(LOCATIONRUNARRAY& rarLocations, CWnd* pParent /* = NULL*/) 
                : CDialog(CRunWorkoutPoolDlg::IDD, pParent), 
                m_rarLocations(rarLocations)
{
}


CRunWorkoutPoolDlg::~CRunWorkoutPoolDlg()
{
}


BOOL CRunWorkoutPoolDlg::OnInitDialog(void)
{
    ...
    SetDlgItemText(IDC_DISPLAYNAME, "Pool");
...
void CRunWorkoutPoolDlg::OnAddData(void)
{
...
void CRunWorkoutPoolDlg::OnConvert(void)
{
    CConverterDlg dlg;
    dlg.DoModal();
}
...
void CRunWorkoutPoolDlg::OnOK(void)
{
    bool fOK;
...
void CRunWorkoutPoolDlg::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CRunWorkoutPoolDlg::OnUpdatePaces(void)
{
    CDlgHelper::HandleDlgPaceOneTime(this, m_edtSeconds.GetValue(false), m_edtDist.GetValue(false), IDC_PACE, FORMAT_RUN);
}


double CRunWorkoutPoolDlg::GetSeconds(void) const
{
    return m_dSeconds;
}


int CRunWorkoutPoolDlg::GetTemperature(void) const
{
    return m_nTemp;
}


int CRunWorkoutPoolDlg::GetHR(void) const
{
    return m_nHR;
}


bool CRunWorkoutPoolDlg::IsLong(void) const
{
    return m_fLong;
}


CString CRunWorkoutPoolDlg::GetNotes(void) const
{
    return m_strNotes;
}


CString CRunWorkoutPoolDlg::GetDispName(void) const
{
    return m_strDisp;
}

double CRunWorkoutPoolDlg::GetMiles(void) const
{
    return m_dMiles;
}


CLocationRun* CRunWorkoutPoolDlg::GetLocation(void) const
{
    return m_pLocation;
}


void CRunWorkoutPoolDlg::SetSeconds(double dSec)
{
    m_dSeconds = dSec;
}


void CRunWorkoutPoolDlg::SetTemperature(int nTemp)
{
    m_nTemp = nTemp;
}


void CRunWorkoutPoolDlg::SetHR(int nHR)
{
    m_nHR = nHR;
}


void CRunWorkoutPoolDlg::SetLong(bool fLong)
{
    m_fLong = fLong;
}


void CRunWorkoutPoolDlg::SetNotes(CString str)
{
    m_strNotes = str;
}


void CRunWorkoutPoolDlg::SetDispName(CString str)
{
    m_strDisp = str;
}


void CRunWorkoutPoolDlg::SetMiles(double dMiles)
{
    m_dMiles = dMiles;
}


void CRunWorkoutPoolDlg::SetLocation(CLocationRun* pLocation)
{
