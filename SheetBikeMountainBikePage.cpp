...
BEGIN_MESSAGE_MAP(CSheetBikeMountainBikePage, CSheetTriathLogPage)
...
CSheetBikeMountainBikePage::CSheetBikeMountainBikePage(void) : CSheetTriathLogPage(CSheetBikeMountainBikePage::IDD)
{
}


BOOL CSheetBikeMountainBikePage::OnInitDialog(void)
{
...
bool CSheetBikeMountainBikePage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetBikeMountainBikePage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetBikeMountainBikePage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetBikeMountainBikePage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetBikeMountainBikePage::OnUpdatePaces(void)
{
