...
BEGIN_MESSAGE_MAP(CSheetBikeEZPage, CSheetTriathLogPage)
...
CSheetBikeEZPage::CSheetBikeEZPage(void) : CSheetTriathLogPage(CSheetBikeEZPage::IDD)
{
}


BOOL CSheetBikeEZPage::OnInitDialog(void)
{
...
bool CSheetBikeEZPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetBikeEZPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetBikeEZPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetBikeEZPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetBikeEZPage::OnUpdatePaces(void)
{
