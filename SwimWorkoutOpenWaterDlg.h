...
class CSwimWorkoutOpenWaterDlg : public CDialog
{
public:
	CSwimWorkoutOpenWaterDlg(LOCATIONSWIMARRAY& rarLocations, CWnd* pParent = NULL);   
	virtual ~CSwimWorkoutOpenWaterDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSWIMWORKOUTOPENWATER };
...
protected:
    ...
    DECLARE_DYNAMIC(CSwimWorkoutOpenWaterDlg)
    DECLARE_MESSAGE_MAP()
