...
class CAddCourseSwimDlg : public CAniDialog
{
public:
	CAddCourseSwimDlg(CWnd* pParent = NULL);   
	virtual ~CAddCourseSwimDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDCOURSESWIMDLG };
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CAddCourseSwimDlg)
