...
BEGIN_MESSAGE_MAP(CSheetRunTreadmillPage, CSheetTriathLogPage)
...
CSheetRunTreadmillPage::CSheetRunTreadmillPage(void) : CSheetTriathLogPage(CSheetRunTreadmillPage::IDD)
{
}


BOOL CSheetRunTreadmillPage::OnInitDialog(void)
{
...
bool CSheetRunTreadmillPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetRunTreadmillPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetRunTreadmillPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetRunTreadmillPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetRunTreadmillPage::OnUpdatePaces(void)
{
