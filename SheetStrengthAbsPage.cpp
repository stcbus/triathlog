...
BEGIN_MESSAGE_MAP(CSheetStrengthAbsPage, CSheetTriathLogPage)
...
CSheetStrengthAbsPage::CSheetStrengthAbsPage(void) : CSheetTriathLogPage(CSheetStrengthAbsPage::IDD)
{
}


BOOL CSheetStrengthAbsPage::OnInitDialog(void)
{
...
bool CSheetStrengthAbsPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetStrengthAbsPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetStrengthAbsPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetStrengthAbsPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetStrengthAbsPage::OnUpdatePaces(void)
{
}