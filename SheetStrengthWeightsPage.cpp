...
BEGIN_MESSAGE_MAP(CSheetStrengthWeightsPage, CSheetTriathLogPage)
...
CSheetStrengthWeightsPage::CSheetStrengthWeightsPage(void) : CSheetTriathLogPage(CSheetStrengthWeightsPage::IDD)
{
}


BOOL CSheetStrengthWeightsPage::OnInitDialog(void)
{
...
bool CSheetStrengthWeightsPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetStrengthWeightsPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetStrengthWeightsPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetStrengthWeightsPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetStrengthWeightsPage::OnUpdatePaces(void)
{
}