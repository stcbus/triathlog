...
class CBikeWorkoutHardDlg : public CDialog
{
public:
	CBikeWorkoutHardDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CBikeWorkoutHardDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDBIKEWORKOUTHARD };
...
protected:
    ...
    DECLARE_DYNAMIC(CBikeWorkoutHardDlg)
    DECLARE_MESSAGE_MAP()
