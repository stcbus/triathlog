...
BEGIN_MESSAGE_MAP(CPEChartSeries2Dlg, CDialog)
    ON_WM_LBUTTONDBLCLK()
    ON_WM_PAINT()
...
CPEChartSeries2Dlg::CPEChartSeries2Dlg(int nNum, bool bCheck, CWnd* pParent) : CDialog(CPEChartSeries2Dlg::IDD, pParent)
{
...
CPEChartSeries2Dlg::~CPEChartSeries2Dlg(void)
{
}


BOOL CPEChartSeries2Dlg::OnInitDialog(void)
{
	...
	if(NULL != pPointBox)
	{
        ...
        pPointBox->SetCurSel(rand() % LAST_POINTTYPE);
...
void CPEChartSeries2Dlg::OnUseSeriesChanged(void)
{
	...
	if((NULL != pWndX) && (NULL != pWndY) && (NULL != pWndZ) && (NULL != pWndSeries) && 
		(NULL != pWndSeriesName) && (NULL != pWndColor) && (NULL != pWndPoint) && (NULL != pWndLine))
	{
		BOOL bEnabled = (BST_CHECKED == IsDlgButtonChecked(IDC_COUNTSERIES));
...
bool CPEChartSeries2Dlg::DoEnableGraphButton(void) const
{
    return true;
}


void CPEChartSeries2Dlg::HandleGraphTypeChanged(int nGraphType)
{
	if(BST_CHECKED != IsDlgButtonChecked(IDC_COUNTSERIES))
	{
		return;
	}
	...
	if((NULL == pWndXAxis) || (NULL == pWndZAxis) || (NULL == pWndPoint) || 
	   (NULL == pWndLine) || (NULL == pSeriesBox))
	{
		return;
	}
...
void CPEChartSeries2Dlg::OnXAxisChanged(void)
{
    bool bFormula = false;
    CString strFormula;
...
void CPEChartSeries2Dlg::OnYAxisChanged(void)
{
    bool bFormula = false;
    CString strFormula;
...
void CPEChartSeries2Dlg::OnZAxisChanged(void)
{
    bool bFormula = false;
    CString strFormula;
...
void CPEChartSeries2Dlg::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	...
	if((BST_CHECKED != IsDlgButtonChecked(IDC_COUNTSERIES)) || (GRAPHTYPE_PIE == pParent->GetGraphType()))
	{
		return;
	}
...
void CPEChartSeries2Dlg::OnPaint(void)
{
    CPaintDC dc(this);
    ...
    if(NULL != pWnd)
    {
		...
		if((BST_CHECKED != IsDlgButtonChecked(IDC_COUNTSERIES)) || (GRAPHTYPE_PIE == pParent->GetGraphType()))
		{
			int nGS = (int)((GetRValue(cr) + GetGValue(cr) + GetBValue(cr)) / 3);
			cr = RGB(nGS, nGS, nGS);
		}
...
void CPEChartSeries2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}


bool CPEChartSeries2Dlg::ChooseNewColor(COLORREF& rcrPicked, COLORREF crStart)
{
...
COLORREF CPEChartSeries2Dlg::GetLineColor(void) const
{
    return m_crLine;
}


void CPEChartSeries2Dlg::SetLineColor(COLORREF cr)
{
    m_crLine = cr;
}


COLORREF CPEChartSeries2Dlg::GetPointColor(void) const
{
    return m_crPoint;
}


void CPEChartSeries2Dlg::SetPointColor(COLORREF cr)
{
    m_crPoint = cr;
}


void CPEChartSeries2Dlg::SetParentDlg(CPEChartDlg* pDlg)
{
    m_pParentDlg = pDlg;
}


CPEChartDlg* CPEChartSeries2Dlg::GetParentDlg(void) const
{
    return m_pParentDlg;
}


int CPEChartSeries2Dlg::GetXAxisType(void) const
{
    int nXType = 1;
    CComboBox* pXBox = (CComboBox*)GetDlgItem(IDC_XAXIS);
    if(NULL != pXBox)
...
int CPEChartSeries2Dlg::GetYAxisType(void) const
{
    int nYType = 1;
    CComboBox* pYBox = (CComboBox*)GetDlgItem(IDC_YAXIS);
    if(NULL != pYBox)
...
int CPEChartSeries2Dlg::GetZAxisType(void) const
{
    int nZType = 1;
    CComboBox* pZBox = (CComboBox*)GetDlgItem(IDC_ZAXIS);
    if(NULL != pZBox)
...
CString CPEChartSeries2Dlg::GetSeriesTitle(void) const
{
    return m_edtSeriesTitle.GetValue();
}


int CPEChartSeries2Dlg::GetSeriesType(void) const
{
	int nType = 0;
...
int CPEChartSeries2Dlg::GetPointType(void) const
{
	int nType = 0;
...
int CPEChartSeries2Dlg::GetLineType(void) const
{
	int nType = 0;
...
bool CPEChartSeries2Dlg::ShouldUseSeries(void) const
{
	return (BST_CHECKED == IsDlgButtonChecked(IDC_COUNTSERIES));
}


CString CPEChartSeries2Dlg::GetFormulaX(void) const
{
    return m_strXFormula;
}


CString CPEChartSeries2Dlg::GetFormulaY(void) const
{
    return m_strYFormula;
}


CString CPEChartSeries2Dlg::GetFormulaZ(void) const
{
    return m_strZFormula;
}


CString CPEChartSeries2Dlg::TranslateToEnglish(CString str, bool fForTitle)
{
    CString strRes;
...
CString CPEChartSeries2Dlg::CharToFunction(char ch, bool fForTitle)
{
    switch(ch)
    {
    case 'B':
