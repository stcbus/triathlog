...
class CAddCourseTriathlonDlg : public CAniDialog
{
public:
	CAddCourseTriathlonDlg(CWnd* pParent = NULL);   
	virtual ~CAddCourseTriathlonDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDCOURSETRIATHLONDLG };
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CAddCourseTriathlonDlg)
