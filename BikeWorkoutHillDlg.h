...
class CBikeWorkoutHillDlg : public CDialog
{
public:
	CBikeWorkoutHillDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CBikeWorkoutHillDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDBIKEWORKOUTHILLS };
...
protected:
    ...
    DECLARE_DYNAMIC(CBikeWorkoutHillDlg)
    DECLARE_MESSAGE_MAP()
