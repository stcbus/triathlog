...
class CBikeWorkoutMiscDlg : public CDialog
{
public:
	CBikeWorkoutMiscDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CBikeWorkoutMiscDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDBIKEWORKOUTOTHER };
...
protected:
    ...
    DECLARE_DYNAMIC(CBikeWorkoutMiscDlg)
    DECLARE_MESSAGE_MAP()
