...
IMPLEMENT_DYNAMIC(CBikeWorkoutHillDlg, CDialog)


BEGIN_MESSAGE_MAP(CBikeWorkoutHillDlg, CDialog)
...
CBikeWorkoutHillDlg::CBikeWorkoutHillDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent /* = NULL*/) 
                : CDialog(CBikeWorkoutHillDlg::IDD, pParent), 
...
CBikeWorkoutHillDlg::~CBikeWorkoutHillDlg()
{
}


BOOL CBikeWorkoutHillDlg::OnInitDialog(void)
{
    ...
    SetDlgItemText(IDC_DISPLAYNAME, "Hills");
...
void CBikeWorkoutHillDlg::OnAddData(void)
{
...
void CBikeWorkoutHillDlg::OnConvert(void)
{
    CConverterDlg dlg;
    dlg.DoModal();
}
...
void CBikeWorkoutHillDlg::OnOK(void)
{
    bool fOK;
...
void CBikeWorkoutHillDlg::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CBikeWorkoutHillDlg::OnUpdatePaces(void)
{
...
double CBikeWorkoutHillDlg::GetSeconds(void) const
{
    return m_dSeconds;
}


int CBikeWorkoutHillDlg::GetTemperature(void) const
{
    return m_nTemp;
}


int CBikeWorkoutHillDlg::GetHR(void) const
{
    return m_nHR;
}


bool CBikeWorkoutHillDlg::IsLong(void) const
{
    return m_fLong;
}


CString CBikeWorkoutHillDlg::GetNotes(void) const
{
    return m_strNotes;
}


CString CBikeWorkoutHillDlg::GetDispName(void) const
{
    return m_strDisp;
}


double CBikeWorkoutHillDlg::GetMiles(void) const
{
    return m_dMiles;
}


CLocationBike* CBikeWorkoutHillDlg::GetLocation(void) const
{
    return m_pLocation;
}


CBike* CBikeWorkoutHillDlg::GetBike(void) const
{
    return m_pBike;
}


CShoesBike* CBikeWorkoutHillDlg::GetShoes(void) const
{
    return m_pShoes;
}


int CBikeWorkoutHillDlg::GetWind(void) const
{
    return m_nWind;
}


double CBikeWorkoutHillDlg::GetSpecialSeconds(void) const
{
    return m_dHillSeconds;
}


double CBikeWorkoutHillDlg::GetSpecialMiles(void) const
{
    return m_dHillMiles;
}


void CBikeWorkoutHillDlg::SetSeconds(double dSec)
{
    m_dSeconds = dSec;
}


void CBikeWorkoutHillDlg::SetTemperature(int nTemp)
{
    m_nTemp = nTemp;
}


void CBikeWorkoutHillDlg::SetHR(int nHR)
{
    m_nHR = nHR;
}


void CBikeWorkoutHillDlg::SetLong(bool fLong)
{
    m_fLong = fLong;
}


void CBikeWorkoutHillDlg::SetNotes(CString str)
{
    m_strNotes = str;
}


void CBikeWorkoutHillDlg::SetDispName(CString str)
{
    m_strDisp = str;
}


void CBikeWorkoutHillDlg::SetMiles(double dMiles)
{
    m_dMiles = dMiles;
}


void CBikeWorkoutHillDlg::SetLocation(CLocationBike* pLocation)
{
    m_pLocation = pLocation;
}


void CBikeWorkoutHillDlg::SetBike(CBike* pBike)
{
    m_pBike = pBike;
}


void CBikeWorkoutHillDlg::SetShoes(CShoesBike* pShoes)
{
    m_pShoes = pShoes;
}


void CBikeWorkoutHillDlg::SetWind(int nWind)
{
    m_nWind = nWind;
}


void CBikeWorkoutHillDlg::SetSpecialSeconds(double dSec)
{
    m_dHillSeconds = dSec;
}


void CBikeWorkoutHillDlg::SetSpecialMiles(double dMiles)
{
    m_dHillMiles = dMiles;
}