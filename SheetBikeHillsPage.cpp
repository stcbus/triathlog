...
BEGIN_MESSAGE_MAP(CSheetBikeHillsPage, CSheetTriathLogPage)
...
CSheetBikeHillsPage::CSheetBikeHillsPage(void) : CSheetTriathLogPage(CSheetBikeHillsPage::IDD)
{
}


BOOL CSheetBikeHillsPage::OnInitDialog(void)
{
...
bool CSheetBikeHillsPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetBikeHillsPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetBikeHillsPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetBikeHillsPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetBikeHillsPage::OnUpdatePaces(void)
{
