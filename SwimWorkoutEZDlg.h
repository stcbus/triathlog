...
class CSwimWorkoutEZDlg : public CDialog
{
public:
	CSwimWorkoutEZDlg(LOCATIONSWIMARRAY& rarLocations, CWnd* pParent = NULL);   
	virtual ~CSwimWorkoutEZDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSWIMWORKOUTEZ };
...
protected:
    ...
    DECLARE_DYNAMIC(CSwimWorkoutEZDlg)
    DECLARE_MESSAGE_MAP()
