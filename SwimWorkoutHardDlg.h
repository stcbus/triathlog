...
class CSwimWorkoutHardDlg : public CDialog
{
public:
	CSwimWorkoutHardDlg(LOCATIONSWIMARRAY& rarLocations, CWnd* pParent = NULL);   
	virtual ~CSwimWorkoutHardDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSWIMWORKOUTHARD };
...
protected:
    ...
    DECLARE_DYNAMIC(CSwimWorkoutHardDlg)
    DECLARE_MESSAGE_MAP()
