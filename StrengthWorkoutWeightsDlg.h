...
class CStrengthWorkoutWeightsDlg : public CDialog
{
public:
	CStrengthWorkoutWeightsDlg(LOCATIONSTRENGTHARRAY& rarLocations, CWnd* pParent = NULL);   
	virtual ~CStrengthWorkoutWeightsDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSTRENGTHWORKOUTWEIGHTS };
...
protected:
    ...
    DECLARE_DYNAMIC(CStrengthWorkoutWeightsDlg)
    DECLARE_MESSAGE_MAP()
