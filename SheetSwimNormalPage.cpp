...
BEGIN_MESSAGE_MAP(CSheetSwimNormalPage, CSheetTriathLogPage)
...
CSheetSwimNormalPage::CSheetSwimNormalPage(void) : CSheetTriathLogPage(CSheetSwimNormalPage::IDD)
{
}


BOOL CSheetSwimNormalPage::OnInitDialog(void)
{
...
bool CSheetSwimNormalPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetSwimNormalPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetSwimNormalPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetSwimNormalPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetSwimNormalPage::OnUpdatePaces(void)
{
