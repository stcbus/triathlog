...
BEGIN_MESSAGE_MAP(CSheetBikeIntervalsPage, CSheetTriathLogPage)
...
CSheetBikeIntervalsPage::CSheetBikeIntervalsPage(void) : CSheetTriathLogPage(CSheetBikeIntervalsPage::IDD)
{
}


BOOL CSheetBikeIntervalsPage::OnInitDialog(void)
{
...
bool CSheetBikeIntervalsPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetBikeIntervalsPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetBikeIntervalsPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetBikeIntervalsPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetBikeIntervalsPage::OnUpdatePaces(void)
{
