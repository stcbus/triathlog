...
class CRunWorkoutNormalDlg : public CDialog
{
public:
	CRunWorkoutNormalDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent = NULL);   
	virtual ~CRunWorkoutNormalDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRUNWORKOUTNORMAL };
...
protected:
    ...
    DECLARE_DYNAMIC(CRunWorkoutNormalDlg)
    DECLARE_MESSAGE_MAP()
