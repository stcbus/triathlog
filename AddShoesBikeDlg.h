...
class CAddShoesBikeDlg : public CAniDialog
{
public:
	CAddShoesBikeDlg(CWnd* pParent = NULL);   
	virtual ~CAddShoesBikeDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSHOESBIKEDLG };
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CAddShoesBikeDlg)
