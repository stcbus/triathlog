...
class CBikeWorkoutIntervalDlg : public CDialog
{
public:
	CBikeWorkoutIntervalDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CBikeWorkoutIntervalDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDBIKEWORKOUTINTERVALS };
...
protected:
    ...
    DECLARE_DYNAMIC(CBikeWorkoutIntervalDlg)
    DECLARE_MESSAGE_MAP()
