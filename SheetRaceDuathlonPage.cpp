...
BEGIN_MESSAGE_MAP(CSheetRaceDuathlonPage, CSheetTriathLogPage)
...
CSheetRaceDuathlonPage::CSheetRaceDuathlonPage(void) : CSheetTriathLogPage(CSheetRaceDuathlonPage::IDD)
{
}


BOOL CSheetRaceDuathlonPage::OnInitDialog(void)
{
    ...
    if(NULL != pUser)
    {
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L1SHOES), pUser->GetRefShoesRunArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L1SHOES);
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L1RACESHOES), pUser->GetRefShoesRunArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L1SPECSHOES);
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L2SHOES), pUser->GetRefShoesBikeArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L2SHOES);
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L2RACESHOES), pUser->GetRefShoesBikeArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L2SPECSHOES);
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L3SHOES), pUser->GetRefShoesRunArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L3SHOES);
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L3RACESHOES), pUser->GetRefShoesRunArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L3SPECSHOES);
        ...
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_COURSE), pUser->GetRefCourseDuathlonArray(), true, true);
        CDlgHelper::FillComboBox((CComboBox*)GetDlgItem(IDC_L2RACEBIKE), pUser->GetRefBikeArray(), true, true, true, SPORT_RACEDU, RACEDUFIELD_L2BIKE);
    }
...
bool CSheetRaceDuathlonPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetRaceDuathlonPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
    ...
    CRaceDuathlonWorkout* pWorkout = dynamic_cast<CRaceDuathlonWorkout*>(GetWorkout());
    CUser* pUser = GetUser();
    ...
    CCourseDuathlon* pCourse = CDlgHelper::GetComboSel((CComboBox*)GetDlgItem(IDC_COURSE), pUser->GetRefCourseDuathlonArray(), fOK);
    ...
    pWorkout->SetLeg1Wind(CDlgHelper::GetComboSelWind((CComboBox*)GetDlgItem(IDC_L1WIND), fOK));
	pWorkout->SetLeg1Shoes(CDlgHelper::GetComboSel((CComboBox*)GetDlgItem(IDC_L1SHOES), pUser->GetRefShoesRunArray(), true, fOK));
    pWorkout->SetLeg1RaceShoes(CDlgHelper::GetComboSel((CComboBox*)GetDlgItem(IDC_L1RACESHOES), pUser->GetRefShoesRunArray(), true, fOK));
    ...
    pWorkout->SetCourseDuathlon(pCourse);
...
void CSheetRaceDuathlonPage::InitDialogValues(void)
{
	...
	CDlgHelper::SetDlgDouble(this, IDC_L1DISTANCE, pWorkout->GetLeg1Miles(), pUser->GetRunDecimals());
    CDlgHelper::SetComboSelWind((CComboBox*)GetDlgItem(IDC_L1WIND), pWorkout->GetLeg1Wind());
    ...
    CDlgHelper::SetComboSel((CComboBox*)GetDlgItem(IDC_L1SHOES), pUser->GetRefShoesRunArray(), true, pWorkout->GetLeg1Shoes());
    CDlgHelper::SetDlgOneTime(this, IDC_L1TIMERACE, pWorkout->GetLeg1RaceSeconds());
    CDlgHelper::SetComboSel((CComboBox*)GetDlgItem(IDC_L1RACESHOES), pUser->GetRefShoesRunArray(), true, pWorkout->GetLeg1RaceShoes());
...
void CSheetRaceDuathlonPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetRaceDuathlonPage::OnUpdatePaces(void)
{
    bool fOK;
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
