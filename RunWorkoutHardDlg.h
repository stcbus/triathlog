...
class CRunWorkoutHardDlg : public CDialog
{
public:
	CRunWorkoutHardDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent = NULL);   
	virtual ~CRunWorkoutHardDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRUNWORKOUTHARD };
...
protected:
    ...
    DECLARE_DYNAMIC(CRunWorkoutHardDlg)
    DECLARE_MESSAGE_MAP()
