...
class CBikeWorkoutEZDlg : public CDialog
{
public:
	CBikeWorkoutEZDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CBikeWorkoutEZDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDBIKEWORKOUTEZ };
...
protected:
    ...
    DECLARE_DYNAMIC(CBikeWorkoutEZDlg)
    DECLARE_MESSAGE_MAP()
