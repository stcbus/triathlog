...
class CAddLocationRunDlg : public CAniDialog
{
public:
	CAddLocationRunDlg(CWnd* pParent = NULL);   
	virtual ~CAddLocationRunDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDLOCATIONRUNDLG };
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CAddLocationRunDlg)
