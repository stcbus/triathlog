...
class CAddCourseRunDlg : public CAniDialog
{
public:
	CAddCourseRunDlg(CWnd* pParent = NULL);   
	virtual ~CAddCourseRunDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDCOURSERUNDLG };
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CAddCourseRunDlg)
