...
class CRunWorkoutHillDlg : public CDialog
{
public:
	CRunWorkoutHillDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent = NULL);   
	virtual ~CRunWorkoutHillDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRUNWORKOUTHILLS };
...
protected:
    ...
    DECLARE_DYNAMIC(CRunWorkoutHillDlg)
    DECLARE_MESSAGE_MAP()
