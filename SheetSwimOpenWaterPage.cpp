...
BEGIN_MESSAGE_MAP(CSheetSwimOpenWaterPage, CSheetTriathLogPage)
...
CSheetSwimOpenWaterPage::CSheetSwimOpenWaterPage(void) : CSheetTriathLogPage(CSheetSwimOpenWaterPage::IDD)
{
}


BOOL CSheetSwimOpenWaterPage::OnInitDialog(void)
{
...
bool CSheetSwimOpenWaterPage::IsChangeAllowed(void)
{
    return true;
}


bool CSheetSwimOpenWaterPage::WriteContents(void)
{
    if(!::IsWindow(m_hWnd))
    {
...
void CSheetSwimOpenWaterPage::InitDialogValues(void)
{
    CWorkout* pWorkout = GetWorkout();
    CUser* pUser = GetUser();
    CDayLog* pDay = GetParentSheet()->GetDay();
...
void CSheetSwimOpenWaterPage::OnUpdateOKButton(void)
{
    bool fEnable = true;
...
void CSheetSwimOpenWaterPage::OnUpdatePaces(void)
{
