...
class CPEChartSeries2Dlg : public CDialog
{
public:
	CPEChartSeries2Dlg(int nNum, bool bCheck, CWnd* pParent = NULL);
    virtual ~CPEChartSeries2Dlg();

	enum { IDD = IDD_PECHARTSERIES2DLG };
