...
class CRunWorkoutTreadmillDlg : public CDialog
{
public:
	CRunWorkoutTreadmillDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent = NULL);   
	virtual ~CRunWorkoutTreadmillDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRUNWORKOUTTREADMILL };
...
protected:
    ...
    DECLARE_DYNAMIC(CRunWorkoutTreadmillDlg)
    DECLARE_MESSAGE_MAP()
