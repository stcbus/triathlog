...
class CRunWorkoutTempoDlg : public CDialog
{
public:
	CRunWorkoutTempoDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent = NULL);   
	virtual ~CRunWorkoutTempoDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRUNWORKOUTTEMPO };
...
protected:
    ...
    DECLARE_DYNAMIC(CRunWorkoutTempoDlg)
    DECLARE_MESSAGE_MAP()
