...
class CStrengthWorkoutMiscDlg : public CDialog
{
public:
	CStrengthWorkoutMiscDlg(LOCATIONSTRENGTHARRAY& rarLocations, CWnd* pParent = NULL);   
	virtual ~CStrengthWorkoutMiscDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSTRENGTHWORKOUTOTHER };
...
protected:
    ...
    DECLARE_DYNAMIC(CStrengthWorkoutMiscDlg)
    DECLARE_MESSAGE_MAP()
