...
{                   
  ...
  VERIFY(CreateEx(WS_EX_TOPMOST | WS_EX_TOOLWINDOW, pszWndClass, _T(""), WS_OVERLAPPEDWINDOW | WS_BORDER | WS_POPUP | WS_VISIBLE & ~WS_SYSMENU, 0, 0, m_nWidth, m_nHeight, m_wndOwner.GetSafeHwnd(), NULL));
