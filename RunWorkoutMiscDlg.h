...
class CRunWorkoutMiscDlg : public CDialog
{
public:
	CRunWorkoutMiscDlg(LOCATIONRUNARRAY& rarLocations, SHOESRUNARRAY& rarShoes, CWnd* pParent = NULL);   
	virtual ~CRunWorkoutMiscDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDRUNWORKOUTOTHER };
...
protected:
    ...
    DECLARE_DYNAMIC(CRunWorkoutMiscDlg)
    DECLARE_MESSAGE_MAP()
