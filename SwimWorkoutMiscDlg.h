...
class CSwimWorkoutMiscDlg : public CDialog
{
public:
	CSwimWorkoutMiscDlg(LOCATIONSWIMARRAY& rarLocations, CWnd* pParent = NULL);   
	virtual ~CSwimWorkoutMiscDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDSWIMWORKOUTOTHER };
...
protected:
    ...
    DECLARE_DYNAMIC(CSwimWorkoutMiscDlg)
    DECLARE_MESSAGE_MAP()
