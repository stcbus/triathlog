...
class CBikeWorkoutNormalDlg : public CDialog
{
public:
	CBikeWorkoutNormalDlg(LOCATIONBIKEARRAY& rarLocations, SHOESBIKEARRAY& rarShoes, BIKEARRAY& rarBikes, CWnd* pParent = NULL);   
	virtual ~CBikeWorkoutNormalDlg();

    virtual BOOL OnInitDialog(void);
    virtual void OnOK(void);

	enum { IDD = IDD_ADDBIKEWORKOUTNORMAL };
...
protected:
    ...
    DECLARE_DYNAMIC(CBikeWorkoutNormalDlg)
    DECLARE_MESSAGE_MAP()
